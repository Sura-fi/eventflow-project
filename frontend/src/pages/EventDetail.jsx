...
// // 1. Add the delete function inside the EventDetail component
// const handleDelete = async () => {
//   if (window.confirm("Are you sure you want to delete this event? This cannot be undone.")) {
//     try {
//       await api.delete(`/api/events/${id}/`);
//       alert("Event deleted successfully!");
//       navigate("/events"); // Send them back to the list after deleting
//     } catch (err) {
//       alert("Error deleting event. Are you the creator?");
//     }
//   }
// };
