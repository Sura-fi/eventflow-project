...
//             Welcome back, <span className="text-indigo-600">Explorer!</span>
//           </h1>
//           <p className="text-gray-500 mt-2 font-medium">Here's what's happening with your events today.</p>
//         </div>
...
//           {/* Action Card 1 */}
//           <Link to="/events" className="group relative overflow-hidden bg-indigo-600 rounded-[2.5rem] p-8 text-white shadow-xl shadow-indigo-200 hover:-translate-y-2 transition-all duration-300">
...
//           {/* Action Card 2 */}
//           <Link to="/my-registrations" className="group relative overflow-hidden bg-white rounded-[2.5rem] p-8 text-gray-900 border border-gray-100 shadow-xl shadow-slate-200/50 hover:-translate-y-2 transition-all duration-300">
//             <div className="relative z-10">
...
//               <p className="text-gray-500 mb-6 max-w-[240px]">View your tickets and manage the events you're attending.</p>
...
//              <button className="flex items-center gap-2 px-6 py-3 bg-white border border-gray-200 rounded-xl text-sm font-bold text-gray-700 hover:bg-gray-50 transition-colors">
//                 <PlusCircle className="w-4 h-4 text-indigo-600" /> Create New Event
//              </button>
//              <button className="flex items-center gap-2 px-6 py-3 bg-white border border-gray-200 rounded-xl text-sm font-bold text-gray-700 hover:bg-gray-50 transition-colors">
